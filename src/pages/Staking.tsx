        ...
        <>
            <div className="w-full flex flex-col border bg-gray-100 rounded-md shadow-lg staking">
                ...
                <div className="p-4">
                    ...
                    <p className="mt-4">Moj APWR zostatok: {userAmount}</p>
                </div>

                <div className="mt-4 flex gap-4 items-center px-4">
                    <input type="number" name="amount" id="amount"
                        value={inputValue} className="w-full p-2 rounded-md border hover:shadow-lg"
                        placeholder="Mnozstvo APWR na stakenutie"
                        step="0.000000001"
                        max="999999999.999999999"
                     />
                    <button onClick={useMax} className="bg-[#004cff] text-white rounded-md p-2 w-full hover:shadow-lg border uppercase">Maximum</button>
                </div>
