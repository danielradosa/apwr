const Staking = () => {
    ...
    return (
        <div className="w-full md:w-2/3 flex flex-col border bg-gray-100 rounded-md shadow-lg">
            ...
            <div className="mt-4 flex gap-4 items-center px-4">
                ...
                <button className="bg-[#004cff] text-white rounded-md p-2 w-full hover:shadow-lg border">Maximum</button>
            </div>

            <div className="mt-4 flex gap-4 items-center px-4 pb-4">
                <button className="bg-[#004cff] text-white rounded-md p-2 w-full hover:shadow-lg border">Stakenut</button>
                <button className="bg-[#004cff] text-white rounded-md p-2 w-full hover:shadow-lg border">Unstakenut vsetko</button>
            </div>
        </div>
    );
}
